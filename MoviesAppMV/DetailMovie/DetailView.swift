...
class DetailView: ViewController {
    ...
    func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            moviewName.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            moviewName.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            moviewName.topAnchor.constraint(equalTo: movieImageView.bottomAnchor, constant: 20),
            ...
            moviewDescription.topAnchor.constraint(equalTo: moviewName.bottomAnchor, constant: 20),
        ])
    }
}
